...
- [ ] 1. Landing visual + conversion polish (navy `#111f4a` + cornflower `#6495ed`; no green branding)
- [ ] 2. Blog system with routes + 3–5 high-quality Hungarian articles (accurate topics; planned features clearly labeled)
- [ ] 3. Technical SEO: sitemap, robots.txt, per-page title/description/OG, canonical URLs, JSON-LD, semantic headings, landing↔blog internal links
