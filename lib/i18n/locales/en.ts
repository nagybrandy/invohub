...
export default {
  ...
  invoices: {
    ...
    emptyHint: "Create your first invoice or load demo data from Settings.",
    ...
    deleteConfirm: "Remove {{number}}?",
    issuedOn: "Issued {{date}}",
    quickPreviewHint: "Quick preview · long-press to delete",
    showingPartial: "Showing {{shown}} of {{total}} invoices (most recent first).",
    stats: {
      total: "Total",
  ...
  dashboard: {
    ...
    paid: "Paid",
    issued: "Drafts & proformas",
    outstanding: "Outstanding",
    estimatedVat: "Estimated VAT (paid invoices)",
    vatPeriodNote:
      "Sum of VAT on paid line items — an in-app estimate, not a NAV filing.",
