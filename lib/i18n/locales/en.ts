...
export default {
  ...
  invoices: {
    ...
    nav: {
      ...
      missingExchangeRate: "Submission needs a HUF exchange rate on the invoice.",
      noSubmission: "This invoice has no NAV submission yet.",
      retry: "Retry",
  ...
  receipts: {
    ...
    navAlreadySubmitted: "This receipt has already been submitted to NAV.",
  ...
  settings: {
    ...
    pdfScreen: {
      ...
      footerTextPlaceholder: "Thank you for your business!",
      on: "On",
      off: "Off",
      save: "Save settings",
      saving: "Saving…",
  ...
  company: {
    ...
    navTestSection: {
      ...
      checkDemoAvailable: "The demo NAV simulator is available - no NAV account needed.",
      checkSharedTestOk: "Connected to the shared InvoHub NAV test account.",
      checkProductionOk: "Connected to the NAV production environment.",
      checkTestOk: "Connected to the NAV test environment.",
      checkCredentialsMissing: "The NAV technical user details are missing.",
      productionNotEnabled: "The NAV production environment is not enabled on this server.",
      m2mDemoAvailable: "The demo NAV M2M simulator is available - no account needed.",
      m2mTestOk: "Connected to the NAV M2M test environment.",
