...
export default {
  ...
  invoices: {
    ...
    nav: {
      ...
      proformaNotSubmittable: "A díjbekérő nem számla, ezért nem küldhető be a NAV-nak.",
      missingExchangeRate: "A beküldéshez a számlának HUF árfolyamra van szüksége.",
      noSubmission: "Ehhez a számlához még nincs NAV beküldés.",
      retry: "Újrapróbálás",
    ...
    timeline: {
      ...
      dueInDays_other: "{{count}} nap múlva",
      overdueDays_one: "{{count}} napja lejárt",
      overdueDays_other: "{{count}} napja lejárt",
      partiallyPaidHint: "Részben fizetve",
      navLabel: "NAV Online Számla",
      navNotSubmitted: "Nincs beküldve",
    },
    status: {
      sent: "Kiküldve",
      draft: "Piszkozat",
  ...
  receipts: {
    ...
    navAlreadySubmitted: "Ez a nyugta már be lett küldve a NAV-nak.",
  ...
  settings: {
    ...
    taxAudit: {
      title: "Adóhatósági ellenőrzési adatszolgáltatás",
      hint:
        "A kiállított számlák exportja a NAV által előírt XML szerkezetben (23/2014. (VI. 30.) NGM rendelet 11/A. §), időszak vagy sorszámtartomány szerint. Piszkozatok és díjbekérők nem kerülnek bele.",
      modeLabel: "Szűrés módja",
      modeDate: "Időszak",
      modeNumber: "Sorszámtartomány",
      from: "Kezdő dátum",
      to: "Záró dátum",
      fromNumber: "Kezdő sorszám",
      toNumber: "Záró sorszám",
      download: "XML letöltése",
      webOnly: "A letöltés jelenleg csak a webes felületen érhető el.",
      errors: {
        selectionRequired: "Adj meg egy időszakot vagy egy sorszámtartományt.",
        ambiguousSelection: "Egyszerre csak időszak vagy sorszámtartomány adható meg.",
        invalidDate: "Érvénytelen dátum — ÉÉÉÉ-HH-NN formátumot használj.",
        invalidRange: "A kezdő érték nem lehet későbbi a zárónál.",
        invalidNumber: "Érvénytelen sorszám (pl. INV-2026-00001).",
        numberSeriesMismatch: "A kezdő és a záró sorszám ugyanabba a sorozatba kell tartozzon (pl. mindkettő INV-).",
        noInvoices: "Ebben a tartományban nincs kiállított számla.",
        tooManyInvoices: "Túl sok számla ({{limit}} felett) — szűkítsd a tartományt, és töltsd le több részletben.",
        incompleteInvoiceData:
          "Az export nem készíthető el, mert az alábbi számlákból hiányzik a NAV-séma szerint kötelező adat:",
        exportFailed: "Az export nem sikerült. Próbáld újra később.",
      },
      fields: {
        sellerTaxNumber: "saját adószám hiányzik vagy hibás (Céges profil)",
        sellerName: "saját név hiányzik (Céges profil)",
        sellerZipCode: "saját irányítószám hiányzik vagy hibás (Céges profil)",
        sellerCity: "saját település hiányzik (Céges profil)",
        sellerStreet: "saját cím hiányzik (Céges profil)",
        buyerName: "vevő neve hiányzik",
        buyerTaxNumber: "vevő adószáma hibás",
        buyerZipCode: "vevő irányítószáma hiányzik vagy hibás (4–10 karakter)",
        buyerCity: "vevő települése hiányzik",
        buyerStreet: "vevő címe hiányzik",
        issueDate: "számla kelte hibás",
        exchangeRate: "devizás számla árfolyama hiányzik",
        originalInvoiceNumber: "az eredeti (sztornózott/módosított) számla sorszáma nem található",
        lineItems: "nincs számlatétel",
      },
    },
    ...
    pdfScreen: {
      ...
      footerTextPlaceholder: "Köszönjük a bizalmat!",
      on: "Be",
      off: "Ki",
  ...
  company: {
    ...
    navTestSection: {
      ...
      checkDemoAvailable: "A demó NAV szimulátor elérhető — nincs szükség NAV-fiókra.",
      checkSharedTestOk: "Sikeres kapcsolat a közös InvoHub NAV teszt fiókkal.",
      checkProductionOk: "Sikeres kapcsolat az éles NAV környezettel.",
      checkTestOk: "Sikeres kapcsolat a NAV teszt környezettel.",
      checkCredentialsMissing: "Hiányoznak a NAV technikai felhasználó adatai.",
      productionNotEnabled: "Az éles NAV környezet ezen a szerveren nincs engedélyezve.",
      m2mDemoAvailable: "A demó NAV M2M szimulátor elérhető — nincs szükség fiókra.",
      m2mTestOk: "Sikeres kapcsolat a NAV M2M teszt környezettel.",
