...
export default {
  ...
  invoices: {
    ...
    emptyHint: "Hozd létre az első számládat, vagy tölts be demo adatokat a Beállításokból.",
    ...
    deleteConfirm: "Töröljük a(z) {{number}} számlát?",
    issuedOn: "Kelt: {{date}}",
    quickPreviewHint: "Gyors előnézet · hosszan nyomva törlés",
    showingPartial: "{{shown}} / {{total}} számla (legújabbak elöl).",
    stats: {
      total: "Összesen",
  ...
  dashboard: {
    ...
    paid: "Fizetve",
    issued: "Piszkozatok és díjbekérők",
    outstanding: "Kintlévő",
    estimatedVat: "Becsült ÁFA (fizetett számlák)",
    vatPeriodNote:
      "A fizetett számlák tételsorainak ÁFA összege — alkalmazáson belüli becslés, nem NAV bevallás.",
